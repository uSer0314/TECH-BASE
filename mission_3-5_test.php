<html>
	...
	<body>
				...
				<?php
					...
					$filename = "mission_3-5_test.txt";	//テキストファイルを作成して変数に代入
			...
			<form action="mission_3-5_test.php" method="post">
			...
			<?php
				...
				$filename = "mission_3-5_test.txt";	//テキストファイルを作成
